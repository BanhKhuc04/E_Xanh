...
- Name: 02-navigation.spec.js >> EXANH-002 Global Navigation - navbar/footer/link >> Menu chuyển đúng route: /đăng bài/i
- Location: tests\02-navigation.spec.js:14:5

# Error details

```
Error: Menu /đăng bài/i không chuyển đúng route

expect(received).toContain(expected) // indexOf

Expected substring: "/dang-bai"
      ...
      - generic [ref=e19]:
        ...
        - generic [ref=e29]:
          - link "Đăng nhập" [ref=e30] [cursor=pointer]:
            - /url: /dang-nhap
          - button "Đăng bài" [active] [ref=e31] [cursor=pointer]
    - main [ref=e32]:
      - generic [ref=e34]:
        - generic [ref=e35]:
          - generic [ref=e36]:
