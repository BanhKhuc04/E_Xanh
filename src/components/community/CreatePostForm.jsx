...
function CreatePostForm({
  ...
  return (
    <>
      ...
      <div className="create-post-form__field post-form-group create-post-form__title-group">
        <input
          id="post-title"
          className={`post-form-control create-post-form__title-input ${fieldErrors.title ? 'is-invalid' : ''}`}
          type="text"
          value={form.title}
      ...
      <div className="create-post-form__field post-form-group create-post-form__desc-group">
        <textarea
          id="post-description"
          className={`post-form-control create-post-form__desc-input ${fieldErrors.description ? 'is-invalid' : ''}`}
          rows="1"
          ...
          placeholder="Mô tả ngắn gọn nội dung (tùy chọn)..."
      ...
      <div className="create-post-form__field post-form-group create-post-form__editor-group">
      ...
      <div className="create-post-form__publish-settings">
        <h3 className="create-post-form__settings-title">Cài đặt xuất bản</h3>
