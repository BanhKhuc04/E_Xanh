...
- Name: 01-smoke-routes.spec.js >> EXANH-001 Smoke routes - route không trắng/không crash >> ADMIN-COMMENTS Quản lý bình luận không crash khi truy cập trực tiếp
- Location: tests\01-smoke-routes.spec.js:30:5

# Error details

```
Error: Admin route có console/page error nghiêm trọng
      ...
      - generic [ref=e34]:
        ...
        - generic [ref=e70]:
          ...
          - generic [ref=e77]:
            ...
            - generic [ref=e81]:
              - generic [ref=e82]: Mật khẩu
              - textbox "Mật khẩu" [ref=e83]:
                - /placeholder: Nhập mật khẩu
            - generic [ref=e84]:
              - generic [ref=e85]:
                - checkbox "Ghi nhớ đăng nhập" [ref=e86]
                - generic [ref=e87]: Ghi nhớ đăng nhập
              - button "Quên mật khẩu?" [disabled] [ref=e88] [cursor=pointer]
            - button "Đăng nhập" [ref=e89] [cursor=pointer]
          - paragraph [ref=e90]:
            - text: Chưa có tài khoản?
            - link "Tạo tài khoản ngay" [ref=e91] [cursor=pointer]:
              - /url: /dang-ky
          - generic [ref=e92]:
            - strong [ref=e93]: Bảo mật thông tin
            - paragraph [ref=e94]: Khách chưa đăng nhập vẫn có thể xem bài viết và tính tiền điện. Đăng nhập giúp bạn lưu lại dữ liệu cá nhân hóa.
    - contentinfo [ref=e95]:
      - generic [ref=e96]:
        - generic [ref=e97]:
          - img [ref=e99]
        ...
        - generic [ref=e101]:
          - link "E-XANH về trang chủ" [ref=e102] [cursor=pointer]:
            - /url: /
            - img "E-XANH" [ref=e104]
          - paragraph [ref=e105]: Dùng điện thông minh, sống xanh bền vững.
        - navigation "Liên kết chân trang" [ref=e106]:
          - link "Trang chủ" [ref=e107] [cursor=pointer]:
            - /url: /
          - link "Mẹo tiết kiệm" [ref=e108] [cursor=pointer]:
            - /url: /meo-tiet-kiem
          - link "Cộng đồng" [ref=e109] [cursor=pointer]:
            - /url: /cong-dong
          - link "Kiểm tra tiền điện" [ref=e110] [cursor=pointer]:
            - /url: /kiem-tra-tien-dien
          - link "Về chúng tôi" [ref=e111] [cursor=pointer]:
            - /url: /ve-chung-toi
          - link "Điều khoản" [ref=e112] [cursor=pointer]:
            - /url: /dieu-khoan
          - link "Liên hệ" [ref=e113] [cursor=pointer]:
            - /url: /lien-he
        - paragraph [ref=e115]: © 2024 E-XANH. Made by VanhKhucDev
```
