...
- Name: 01-smoke-routes.spec.js >> EXANH-001 Smoke routes - route không trắng/không crash >> ROUTE-SAVED Bài đã lưu load ổn
        ...
        - generic [ref=e64]:
          ...
          - generic [ref=e68]:
            ...
            - link "Đăng ký" [ref=e70] [cursor=pointer]:
              - /url: /dang-ky
          - alert [ref=e71]: Vui lòng đăng nhập để xem trang này.
          - generic [ref=e72]:
            - generic [ref=e73]:
